...
image::../media/scrn_en_drw_smo_architecture.gif[This figure displays the components associated with a combined SnapManager for Oracle and Management Console database protection architecture]
